...
MAX_FRAMES = 200; % you can change this and consider increasing it.
RESOLUTION = 280; % you can change this and consider increasing it.
DURATION = 10; % Duration of video -- you can change this if you want.

% Colors
MAX_DEPTH = 192; % you will probably need to increase this.
...
PATH_POINTS =[0,   -0.5,            1;
             150, -0.74911+0.099854i,   0.0000005; 
              300,   0.5,            1;
             650, 0.3245046418497685+0.04855101129280834i, 0.000001;];
